...
categories:
  ...
  - CDK
  - DevOps
description: From manual AWS setup to automated infrastructure as code - my journey building a serverless static site with AWS CDK.
...
![Architecture Diagram](assets/Resume_Wesbite.drawio.svg)

Our serverless infrastructure includes:

- **Amazon S3** - Low-cost storage for static assets (HTML, CSS, JS, images)
...
- **Construct** - A reusable building block (like a Lego brick) that creates AWS resources
